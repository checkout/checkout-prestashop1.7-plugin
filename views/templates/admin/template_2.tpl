...
<div class="panel">
	<div class="row checkoutcom-header">
		...
		<div class="col-xs-6 col-md-6 text-center text-muted">
			{l s='My Payment Module and PrestaShop have partnered to provide the easiest way for you to accurately calculate and file sales tax.' mod='checkoutcom'}
		</div>
		<div class="col-xs-12 col-md-3 text-center">
			<a href="#" onclick="javascript:return false;" class="btn btn-primary" id="create-account-btn">{l s='Create an account' mod='checkoutcom'}</a><br />
			{l s='Already have one?' mod='checkoutcom'}<a href="#" onclick="javascript:return false;"> {l s='Log in' mod='checkoutcom'}</a>
		</div>
	</div>
	...
	<div class="checkoutcom-content">
		<div class="row">
			<div class="col-md-5">
				<h5>{l s='Benefits of using my payment module' mod='checkoutcom'}</h5>
				<ul class="ul-spaced">
					<li>
			...
			<div class="col-md-2">
				...
				<dl class="list-unstyled">
					<dt>{l s='Payment Standard' mod='checkoutcom'}</dt>
					<dd>{l s='No monthly fee' mod='checkoutcom'}</dd>
					<dt>{l s='Payment Express' mod='checkoutcom'}</dt>
					<dd>{l s='No monthly fee' mod='checkoutcom'}</dd>
					<dt>{l s='Payment Pro' mod='checkoutcom'}</dt>
					<dd>{l s='$5 per month' mod='checkoutcom'}</dd>
				</dl>
			...
			<div class="col-md-12">
				...
				<div class="row">
					...
					<div class="col-md-9 text-center">
						<h6>{l s='For more information, call 888-888-1234' mod='checkoutcom'} {l s='or' mod='checkoutcom'} <a href="mailto:contact@prestashop.com">contact@prestashop.com</a></h6>
					</div>
				</div>
			</div>
		</div>
...
<div class="panel">
	<p class="text-muted">
		<i class="icon icon-info-circle"></i> {l s='In order to create a secure account with My Payment Module, please complete the fields in the settings panel below:' mod='checkoutcom'}
		{l s='By clicking the "Save" button you are creating secure connection details to your store.' mod='checkoutcom'}
		{l s='My Payment Module signup only begins when you client on "Activate your account" in the registration panel below.' mod='checkoutcom'}
		{l s='If you already have an account you can create a new shop within your account.' mod='checkoutcom'}
	</p>
	<p>
